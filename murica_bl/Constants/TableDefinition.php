...
class TableDefinition {
    ...
    //region TakenCourse table
    const TAKENCOURSE_TABLE = 'MURICA_TAKEN_COURSE';
    const TAKENCOURSE_TABLE_FIELD_USER_ID = 'USER_ID';
    const TAKENCOURSE_TABLE_FIELD_PROGRAMME_NAME = 'PROGRAMME_NAME';
    const TAKENCOURSE_TABLE_FIELD_PROGRAMME_TYPE = 'PROGRAMME_TYPE';
    const TAKENCOURSE_TABLE_FIELD_COURSE_ID = 'COURSE_ID';
    const TAKENCOURSE_TABLE_FIELD_SUBJECT_ID = 'SUBJECT_ID';
    const TAKENCOURSE_TABLE_FIELD_GRADE = 'GRADE';
    const TAKENCOURSE_TABLE_FIELD_APPROVED = 'APPROVED';
    //endregion

    //region Exam table
    const EXAM_TABLE = 'MURICA_EXAM';
    const EXAM_TABLE_FIELD_SUBJECT_ID = 'SUBJECT_ID';
    const EXAM_TABLE_FIELD_ID = 'ID';
    const EXAM_TABLE_FIELD_START_TIME = 'START_TIME';
    const EXAM_TABLE_FIELD_END_TIME = 'END_TIME';
    const EXAM_TABLE_FIELD_TEACHER_ID = 'TEACHER_ID';
    const EXAM_TABLE_FIELD_ROOM_ID = 'ROOM_ID';
    //endregion

    //region TakenExam table
    const TAKEN_EXAM_TABLE = 'MURICA_TAKEN_EXAM';
    const TAKEN_EXAM_TABLE_FIELD_USER_ID = 'USER_ID';
    const TAKEN_EXAM_TABLE_FIELD_PROGRAMME_NAME = 'PROGRAMME_NAME';
    const TAKEN_EXAM_TABLE_FIELD_PROGRAMME_TYPE = 'PROGRAMME_TYPE';
    const TAKEN_EXAM_TABLE_FIELD_EXAM_ID = 'EXAM_ID';
    const TAKEN_EXAM_TABLE_FIELD_SUBJECT_ID = 'SUBJECT_ID';
    //endregion
